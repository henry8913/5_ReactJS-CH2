            ...
            <Row className="mb-4">
              <Col lg={6} className="mb-4 mb-lg-0">
                ...
                <p className="text-muted">
                  Founded in 2020, EPICBooks emerged from a simple idea: to make
                  quality literature accessible to everyone. What started as a
                  small online bookstore has grown into a community of
                  passionate readers and book enthusiasts.
                </p>
              </Col>
              <Col lg={6}>
                <h2 className="h3 mb-4">Our Mission</h2>
                <p className="text-muted">
                  At EPICBooks, we believe that everyone deserves access to
                  quality literature at affordable prices. Our mission is to
                  connect readers with their next favorite book while providing
                ...
                <Card className="h-100 bg-light border-0">
                  <Card.Body className="text-center">
                    ...
                    <p className="text-muted mb-0">
                      Making quality books available to everyone
                    </p>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col md={4} className="mb-4">
                <Card className="h-100">
                  ...
                  <Card.Body className="text-center">
                    ...
                    <p className="small">
                      Book enthusiast with 15 years of experience in publishing.
                    </p>
                  </Card.Body>
                </Card>
              </Col>
              <Col md={4} className="mb-4">
                <Card className="h-100">
                  ...
                  <Card.Body className="text-center">
                    ...
                    <p className="small">
                      Literary critic and former bookstore manager.
                    </p>
                  </Card.Body>
                </Card>
              </Col>
              <Col md={4} className="mb-4">
                <Card className="h-100">
                  ...
                  <Card.Body className="text-center">
                    ...
                    <p className="small">
                      Dedicated to creating amazing reading experiences.
                    </p>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col md={6} className="mb-4">
                <Card className="h-100">
                  <Card.Body>
                    ...
                    <p className="mb-0">
                      "EPICBooks has transformed how I discover new reads. Their
                      curated collection and fast delivery make book shopping a
                      joy. The personal touch in their service is unmatched!"
                    </p>
                  </Card.Body>
                </Card>
              </Col>
              <Col md={6} className="mb-4">
                <Card className="h-100">
                  <Card.Body>
                    ...
                    <p className="mb-0">
                      "As an avid reader, I've tried many online bookstores, but
                      EPICBooks stands out. Their recommendations are spot-on,
            ...
            <Row className="mb-5">
              ...
              <Col md={6}>
                <ul className="list-unstyled">
                  ...
                  <li className="mb-3">
                    <i className="bi bi-envelope me-2"></i>contact@epicbooks.com
                  </li>
                </ul>
